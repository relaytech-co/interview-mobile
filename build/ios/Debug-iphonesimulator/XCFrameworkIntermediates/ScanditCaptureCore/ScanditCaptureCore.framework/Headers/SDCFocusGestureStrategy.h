 ...
 */
SDC_EXTERN BOOL SDCFocusGestureStrategyFromJSONString(NSString *_Nonnull JSONString, SDCFocusGestureStrategy *_Nonnull focusGestureStrategy) DEPRECATED_MSG_ATTRIBUTE("This function will be removed in the future");
