 ...
 *
 * Protocol for location selection. Location selections implement a specific strategy how a data object (like a barcode or text) is selected out of multiple visible ones by for example only selecting objects inside a certain area or objects that intersect a certain area. Implementations are provided by SDCRadiusLocationSelection and SDCRectangularLocationSelection.
 *
