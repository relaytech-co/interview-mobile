 ...
 */
SDC_EXTERN NSString *_Nonnull NSStringFromSizeWithUnit(SDCSizeWithUnit sizeWithUnit) DEPRECATED_MSG_ATTRIBUTE("This function will be removed in the future") NS_SWIFT_NAME(getter:SDCSizeWithUnit.jsonString(self:));
 ...
 * Deprecated since version 6.26.0: This function will be removed in the future.
 */
SDC_EXTERN NSString *_Nonnull NSStringFromRectWithUnit(SDCRectWithUnit rectWithUnit) DEPRECATED_MSG_ATTRIBUTE("This function will be removed in the future") NS_SWIFT_NAME(getter:SDCRectWithUnit.jsonString(self:));
 ...
 * Deprecated since version 6.26.0: This function will be removed in the future.
 */
SDC_EXTERN NSString *_Nonnull NSStringFromSizeWithAspect(SDCSizeWithAspect sizeWithAspect) DEPRECATED_MSG_ATTRIBUTE("This function will be removed in the future") NS_SWIFT_NAME(getter:SDCSizeWithAspect.jsonString(self:));
