...
/**
     ...
     */
    SDCRectangularViewfinderStyleLegacy DEPRECATED_MSG_ATTRIBUTE(
        "This style will be removed in the future"),
/**
     * Added in version 6.8.0
     *
 ...
 */
SDC_EXTERN BOOL SDCRectangularViewfinderStyleFromJSONString(NSString *_Nonnull JSONString, SDCRectangularViewfinderStyle *_Nonnull style) DEPRECATED_MSG_ATTRIBUTE("This function will be removed in the future");
 ...
 * Deprecated since version 6.26.0: This function will be removed in the future.
 */
SDC_EXTERN BOOL SDCRectangularViewfinderLineStyleFromJSONString(NSString *_Nonnull JSONString, SDCRectangularViewfinderLineStyle *_Nonnull style) DEPRECATED_MSG_ATTRIBUTE("This function will be removed in the future");
 ...
 *
 * The amount the area outside the viewfinder’s rectangle is dimmed by when the mode is disabled. Accepts values between 0 (no dimming) and 1 (fully blacked out). Not available for SDCRectangularViewfinderStyleLegacy.
 */
 ...
 * Added in version 6.0.0
 *
 * Constructs a new rectangular viewfinder with SDCRectangularViewfinderStyleLegacy and SDCRectangularViewfinderLineStyleLight.
 *
