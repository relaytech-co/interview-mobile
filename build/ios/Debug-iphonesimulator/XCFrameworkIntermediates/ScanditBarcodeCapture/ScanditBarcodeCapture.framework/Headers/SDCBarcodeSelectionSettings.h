 ...
 *
 * If false, selection through tap is disabled. Defaults to YES. This property only has its effect when used with manual aimer selection.
 */
@property (nonatomic, assign) BOOL tapGestureForSelectionEnabled;
/**
 * Added in version 6.19.0
 *
 * If true, user can swipe right to select all barcodes in the view or swipe left to deselect all barcodes in the view. Defaults to YES.
 */
@property (nonatomic, assign) BOOL swipeGesturesEnabled;
/**
 * Added in version 6.6.0
 *
 ...
 * Added in version 6.19.0
 *
 * Constructs new barcode selection settings based on the provided presets, enabling relevant symbologies and optimizations. See SDCCapturePreset for more information on how to use capture presets.
 */
