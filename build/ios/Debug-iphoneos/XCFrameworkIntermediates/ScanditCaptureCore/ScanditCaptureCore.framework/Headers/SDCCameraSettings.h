 ...
 */
SDC_EXTERN BOOL SDCVideoResolutionFromJSONString(NSString *_Nonnull JSONString, SDCVideoResolution *_Nonnull videoResolution) DEPRECATED_MSG_ATTRIBUTE("This function will be removed in the future");
 ...
 * Deprecated since version 6.26.0: This function will be removed in the future.
 */
SDC_EXTERN BOOL SDCFocusRangeFromJSONString(NSString *_Nonnull JSONString, SDCFocusRange *_Nonnull focusRange) DEPRECATED_MSG_ATTRIBUTE("This function will be removed in the future");
 ...
 */
typedef NS_CLOSED_ENUM(NSUInteger, SDCMacroMode) {
/**
     * Added in version 6.17.0
     *
 ...
 * Deprecated since version 6.26.0: This function will be removed in the future.
 */
SDC_EXTERN NSString *_Nonnull NSStringFromMacroMode(SDCMacroMode macroMode) DEPRECATED_MSG_ATTRIBUTE("This function will be removed in the future") NS_SWIFT_NAME(getter:SDCMacroMode.jsonString(self:));
/**
 * Added in version 6.17.0
 *
 * Deprecated since version 6.26.0: This function will be removed in the future.
 */
SDC_EXTERN BOOL SDCMacroModeFromJSONString(NSString *_Nonnull JSONString, SDCMacroMode *_Nonnull macroMode) DEPRECATED_MSG_ATTRIBUTE("This function will be removed in the future");
