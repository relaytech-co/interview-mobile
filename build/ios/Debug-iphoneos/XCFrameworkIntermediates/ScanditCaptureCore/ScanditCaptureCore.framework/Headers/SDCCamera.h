 ...
 */
NS_SWIFT_NAME(MacroModeListener)
 ...
 *
 * Deprecated since version 6.17.0: With the release of SDCSparkScan we deprecated the standalone sparkScan camera.
 */
@property (class, nonatomic, nullable, readonly)
    SDCCamera *sparkScanCamera DEPRECATED_MSG_ATTRIBUTE("Use SparkScan instead");
/**
 * Added in version 6.17.0
 *
...
+ (nullable SDCCamera *)cameraAtPosition:(SDCCameraPosition)position
    ...
    NS_SWIFT_NAME(init(position:settings:));
...
- (void)addMacroModeListener:(nonnull id<SDCMacroModeListener>)listener
    NS_SWIFT_NAME(addMacroModeListener(_:));
/**
 * Added in version 6.17.0
 *
...
- (void)removeMacroModeListener:(nonnull id<SDCMacroModeListener>)listener
    NS_SWIFT_NAME(removeMacroModeListener(_:));
 ...
 * Added in version 6.0.0
 *
 * Updates the camera according to a JSON serialization.
 */
