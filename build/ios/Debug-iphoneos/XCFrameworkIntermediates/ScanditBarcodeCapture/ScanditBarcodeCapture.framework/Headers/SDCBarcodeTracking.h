 ...
 *
 * Learn more on how to use barcode tracking in our Get Started guide.
 *
 ...
 * Added in version 6.0.0
 *
 * Constructs a new barcode tracking mode with the provided JSON serialization. The capture mode is automatically added to the context.
 */
