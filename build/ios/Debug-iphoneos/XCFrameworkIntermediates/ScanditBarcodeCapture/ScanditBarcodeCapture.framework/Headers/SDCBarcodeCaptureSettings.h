 ...
 *
 * The battery saving mode to use with BarcodeCapture. Defaults to SDCBatterySavingModeAuto, to automatically enable the battery saving mode when a higher than usual consumption of the battery is detected, balancing performance and battery lifetime.
 * Set to SDCBatterySavingModeOff to revert to the standard performance.
 *
 * Deprecated since version 6.26.0: Replaced with batterySaving.
 */
@property (nonatomic, assign)
    SDCBatterySavingMode batterySavingMode DEPRECATED_MSG_ATTRIBUTE("Use batterySaving instead");
 ...
 *
 * The scan intention algorithm to use with BarcodeCapture. Defaults to SDCScanIntentionManual, ensuring the standard performance with no smart algorithms.
 * Set to SDCScanIntentionSmart to enable the automatic algorithm that intelligently identifies and then scans the barcode that the user intends to capture, reducing errors.
 */
