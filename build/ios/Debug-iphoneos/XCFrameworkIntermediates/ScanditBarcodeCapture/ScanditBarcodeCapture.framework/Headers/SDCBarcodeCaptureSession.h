 ...
 * Added in version 6.0.0
 *
 * Resets the barcode capture session, effectively clearing the history of scanned codes. This affects duplicate filtering: when calling reset every frame has the same effect as setting the SDCBarcodeCaptureSettings.codeDuplicateFilter to 0. This function should only be called inside the listeners’ callback.
 */
- (void)reset;
