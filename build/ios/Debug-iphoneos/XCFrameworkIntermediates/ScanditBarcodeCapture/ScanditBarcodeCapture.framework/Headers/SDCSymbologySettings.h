 ...
 *
 * Learn more on how to use symbology settings in our Configure Barcode Symbologies guide.
 */
 ...
 */
@property (nonatomic, strong) NSSet<NSNumber *> *activeSymbolCounts NS_REFINED_FOR_SWIFT;
/**
