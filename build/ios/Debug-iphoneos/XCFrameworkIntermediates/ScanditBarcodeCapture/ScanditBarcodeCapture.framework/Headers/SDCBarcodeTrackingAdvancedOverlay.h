 ...
 * This method will be called before barcodeTrackingAdvancedOverlay:anchorForTrackedBarcode: and barcodeTrackingAdvancedOverlay:offsetForTrackedBarcode:.
 * Beware that this view can be overridden with SDCBarcodeTrackingAdvancedOverlay.setView:forTrackedBarcode: method.
 * This method will only be called for new tracked barcodes that do not have a view yet, e.g. a view set by a call to SDCBarcodeTrackingAdvancedOverlay.setView:forTrackedBarcode:.
 *
...
+ (nullable instancetype)barcodeTrackingAdvancedOverlayFromJSONString:(nonnull NSString *)JSONString
                                                                ...
                                                                error:(NSError *_Nullable *_Nullable)error NS_SWIFT_NAME(init(jsonString:barcodeTracking:));
